...
Änderungen an der Breite im Vgl. zu ResNet18.
Inkl. Dropout-Layer.
...
class ResNet18_Variant(nn.Module):
    def __init__(self, num_classes=6):
        super(ResNet18_Variant, self).__init__()
        self.in_channels = 32
        ...
        self.layer4 = self._make_layer(BasicBlock, 256, 2, stride=1)
